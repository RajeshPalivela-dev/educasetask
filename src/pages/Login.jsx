...
const Login = () => {
  ...
  <form className="w-[375px] h-[812px] bg-[#F7F8F9] relative">
    ...
    {/* Title */}
     <div class="absolute top-[40px] left-[20px] w-[188px] h-[69px] text-left text-[28px] leading-[36px] font-medium text-[#1D2226] font-rubik">Signin to your PopX account
</div>

<p class="absolute top-[123px] left-[20px] w-[232px] h-[48px] text-left text-[18px] leading-[26px] font-normal text-[#1D2226] opacity-60 font-rubik">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
</p>
  ...
  >Password
   ...
   <button class="absolute top-[321px] left-[20px] w-[335px] h-[46px] bg-[#CBCBCB] rounded-[6px] flex items-center justify-center" onClick={()=>navigate("/profile")}>
