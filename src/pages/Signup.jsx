  ...
  return (
    <div className="min-h-screen flex items-center justify-center ">
      <form className="w-[375px] h-[812px] bg-[#F7F8F9] relative">
        ...
        <div className="absolute top-[474px] left-[20px] w-[125px] h-[15px] text-left text-[13px] leading-[17px] font-normal font-rubik opacity-100">
          Are you an Agency?
        ...
        <div className="absolute top-[504px] left-[25px] flex items-center gap-4">
          <label className="flex items-center gap-2 text-[14px] text-[#1D2226]">
            <input
              ...
              name="choice"
              value="Yes"
              className="w-[16px] top-[502px] h-[16px]"
            />
            Yes
          </label>
          ...
          <label className="flex items-center gap-2 text-[14px] text-[#1D2226]">
            <input
              ...
              name="choice"
              value="No"
              className="w-[16px] h-[16px] top-[502px]"
            />
            No
          </label>
        </div>
        ...
        <button
          class="absolute top-[736px] left-[20px] w-[335px] h-[46px] bg-[#6C25FF] rounded-[6px] flex items-center justify-center"
